...
type TailwindTextVariants = VariantProps<typeof tailwindText>;

export interface TailwindTextProps extends TailwindTextVariants {
...
export const TailwindText = (props: TailwindTextProps) => {
	return (
		<div className={tailwindText({ ...props, className: props.className })}>
			{props.children}
		</div>
	);
};
