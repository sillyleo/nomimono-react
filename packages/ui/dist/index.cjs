...
var SecondaryButton = (props) => {
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: secondaryButton(props), children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "px-2.5 py-1 text-white font-medium text-sm text-center leading-snug", children: "Button" }) });
};
