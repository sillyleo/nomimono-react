...
declare const Checkbox: React__default.ForwardRefExoticComponent<Omit<CheckboxExtendedProps, "ref"> & React__default.RefAttributes<HTMLInputElement>>;
...
declare const TailwindButton: ({ children, isLoading, ...props }: TailwindButtonProps) => JSX.Element;

export { AutoSpinner, BaseButton, BaseInput, Box, Button, CSS, Checkbox, Dialog, Display, Footer, HeroIcon, HeroIconOne, LucideIcon, NomiStyle, Radix, Spinner, Stack, TailwindButton, Text, Tone, Tooltip, brandFonts, css, globalCss, keyframes, nomiClass, reset, stitchesDarkTheme, theme as stitchesTheme, styled };
